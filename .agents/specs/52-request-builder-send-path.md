...
- Approved Designer Result: `NXRequestBuilder` 단일 요청 흐름과 1.3 호환성 설계
- User approval: 2026-08-22 `구현 및 커밋 ㄱ`

## Constraints

- 1.3 source compatibility 유지
...
- 기존 `raw()`, `as(_:)`, typed HTTP method overload를 대체 경로 안내가 있는 사용 중단 API로 설정
...
- [x] `raw()`, `as(_:)`, typed HTTP method overload에 사용 중단 표시와 대체 경로 안내
